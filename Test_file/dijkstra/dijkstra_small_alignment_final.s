...
.LFB0:
	...
	movq	%rdi,	-8(%rbp)
	movl	%esi,	-40(%rbp)		#this_line_update!
...
.LFB1:
	...
	.cfi_def_cfa_register	6
	subq	$48,	%rsp		#this_line_update!
	movl	%edi,	-36(%rbp)		#this_line_update!
...
.L4:
	...
	movq	-8(%rbp),	%rax
	movq	$0,	16(%rax)
	cmpq	$0,	-48(%rbp)		#this_line_update!
	jne	.L7
	movq	-8(%rbp),	%rax
	movq	%rax,	qHead(%rip)
	jmp	.L6
...
.LFB2:
	...
	movq	%rdx,	-24(%rbp)		#this_line_update!
	movq	qHead(%rip),	%rax
	movq	%rax,	-8(%rbp)
	movq	qHead(%rip),	%rax
	testq	%rax,	%rax
...
.LFB4:
	...
	.cfi_def_cfa_register	6
	subq	$48,	%rsp		#this_line_update!
	movl	%edi,	-40(%rbp)		#this_line_update!
	movl	%esi,	-8(%rbp)
	movl	$0,	ch(%rip)
	jmp	.L15
.L16:
...
.LFB5:
	...
	.cfi_def_cfa_register	6
	subq	$48,	%rsp		#this_line_update!
	movl	%edi,	-44(%rbp)		#this_line_update!
	movq	%rsi,	-36(%rbp)		#this_line_update!
	movq	%fs:40,	%rax
	movq	%rax,	-8(%rbp)
	xorl	%eax,	%eax
	cmpl	$1,	-44(%rbp)		#this_line_update!
	jg	.L26
	movq	stderr(%rip),	%rax
	movq	%rax,	%rcx
	movl	$27,	%edx
...
.L30:
	...
	jmp	.L28
.L29:
	leaq	-48(%rbp),	%rdx		#this_line_update!
	movq	-24(%rbp),	%rax		#this_line_update!
	leaq	.LC8(%rip),	%rcx
	movq	%rcx,	%rsi
	movq	%rax,	%rdi
	...
	movl	-48(%rbp),	%edx		#this_line_update!
...
.L28:
	cmpl	$99,	-12(%rbp)		#this_line_update!
	jle	.L29
	addl	$1,	-16(%rbp)		#this_line_update!
.L27:
	cmpl	$99,	-16(%rbp)		#this_line_update!
	jle	.L30
	movl	$0,	-16(%rbp)		#this_line_update!
	movl	$50,	-12(%rbp)		#this_line_update!
	jmp	.L31
.L32:
	movl	-12(%rbp),	%eax		#this_line_update!
	movslq	%eax,	%rdx
	...
	addl	$1,	-12(%rbp)		#this_line_update!
.L31:
	cmpl	$19,	-16(%rbp)		#this_line_update!
	jle	.L32
	movl	$0,	%edi
	call	exit@PLT
	.cfi_endproc
